                    ...
                    >
                        <CarouselContent className="-ml-2 md:-ml-4">
                            {groupedClients.map((group, groupIndex) => (
                                <CarouselItem key={groupIndex} className="pl-2 md:pl-4 basis-1/2 sm:basis-1/3 md:basis-1/4 lg:basis-1/5">
                                    <div className="flex flex-col gap-4 py-2">
                                        ...
                                        {group.length < rows && Array.from({ length: rows - group.length }).map((_, i) => (
                                            <div key={`empty-${i}`} className="aspect-[3/2] invisible" />
                                        ))}
                                    </div>
                                </CarouselItem>
                            ))}
                        ...
                        <div className="hidden sm:block">
                            <CarouselPrevious className="-left-4 lg:-left-12 h-12 w-12 border-slate-200 text-slate-600 hover:text-red-600 hover:border-red-200" />
                            <CarouselNext className="-right-4 lg:-right-12 h-12 w-12 border-slate-200 text-slate-600 hover:text-red-600 hover:border-red-200" />
                        </div>
                    </Carousel>
                </div>
            </div>
