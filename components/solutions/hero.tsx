...
export default function SolutionsHero() {
    return (
        <div className="relative isolate overflow-hidden bg-slate-900 pb-16 pt-14 sm:pb-20">
            {/* Background gradients - Red/White Theme */}
            <div
                    ...
                    <div className="text-center">
                        ...
                        >
                            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                                Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-red-600">Solutions</span>
                            </h1>
                            <p className="mt-6 text-lg leading-8 text-gray-300">
                                ELV Technology Solutions provides end-to-end integrated systems for security, audio-visual, networking, and automation needs across the UAE.
                            </p>
                        </motion.div>
                    </div>
                </div>
